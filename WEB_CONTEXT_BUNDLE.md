...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-468d7de66b0d0261"
    ],
    "allowed_axioms": [
    ...
    "problem_id": "problem:wikipedia-468d7de66b0d0261",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-468d7de66b0d0261",
        "url": "https://en.wikipedia.org/wiki/Goormaghtigh_conjecture"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Goormaghtigh conjecture on solutions to $(x^{m}-1)/(x-1)=(y^{n}-1)/(y-1)$ where $x>y>1$ and $m,n>2$ .",
      "version": 1
    },
    "title": "Goormaghtigh conjecture",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "e005c7b722cb8f7c3e6444682c28876ba57355812c58b7024b15ea9ee2360f5a"
}
```
